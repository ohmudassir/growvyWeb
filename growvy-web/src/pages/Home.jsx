    ...
    <>
      ...
      <section className="min-h-screen bg-white pt-10 pb-24 px-6 md:px-12">
        ...
        <div className="bg-white py-16 px-6 md:px-12 mt-28">
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10">
            ...
            <div className="flex-1 flex justify-center">
              <img src="/images/ecommerce-owner.png" alt="E-commerce" className="w-full max-w-sm" />
            </div>
          </div>
        </div>
        ...
        <div className="bg-white py-16 px-6 md:px-12 mt-28">
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10">
            <div className="flex-1 flex justify-center">
              <img src="/images/schedule-call.png" alt="Schedule Call" className="w-full max-w-sm" />
            </div>
